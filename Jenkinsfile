pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/pyakurd'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/dikshyapyakurel/225-lab3-5.git'                                          //<------change this
        KUBECONFIG = credentials('pyakurd-test-credentials')                                                         //<------change this
    }
